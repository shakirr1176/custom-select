class CommonVar {
  constructor() {
    ...
    (this.selectClass = "turn-into-custom-select-js-select"),
      (this.dropDownDivWrapperClass = "turn-into-custom-select-js-option-wrapper");
    (this.dropDownDivClass = "drop-down-bg"), (this.optionClass = "turn-into-custom-select-js-option");
    (this.multiSelectResetIconClass = "turn-into-custom-select-js-multi-select-reset-icon"),
